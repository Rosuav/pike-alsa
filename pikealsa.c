...
#line 105 "pikealsa.cmod"
{msg(SND_SEQ_EVENT_NOTEON,channel,note,velocity);}
	}
...
velocity=Pike_sp[2-3].u.integer;
#line 106 "pikealsa.cmod"
{msg(SND_SEQ_EVENT_NOTEOFF,channel,note,velocity);}
	}
...
#line 107 "pikealsa.cmod"
{msg(SND_SEQ_EVENT_KEYPRESS,channel,note,pressure);}
	}
...
#line 108 "pikealsa.cmod"
{msg(SND_SEQ_EVENT_PGMCHANGE,channel,0,patch);} }
...
#line 109 "pikealsa.cmod"
{msg(SND_SEQ_EVENT_CHANPRESS,channel,0,pressure);}
	}
...
#line 110 "pikealsa.cmod"
{msg(SND_SEQ_EVENT_CONTROLLER,channel,param,value);}
	}
...
#line 111 "pikealsa.cmod"
{msg(SND_SEQ_EVENT_PITCHBEND,channel,0,position);} }
